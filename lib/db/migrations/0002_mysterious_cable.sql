ALTER TABLE "paintings" ADD COLUMN IF NOT EXISTS "image_url" text;--> statement-breakpoint
ALTER TABLE "paintings" ADD COLUMN IF NOT EXISTS "source" text DEFAULT 'artic' NOT NULL;--> statement-breakpoint
