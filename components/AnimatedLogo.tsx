...
export function AnimatedLogo({
  ...
  useGSAP(
    () => {
      ...
      // prime hidden starting state on first mount
      ...
      if (reverseTrigger) {
        // REVERSE — fade fills out while the strokes retract (last → first).
        ...
        const tl = gsap.timeline({
          delay: hasPlayedRef.current ? 0 : 1,
        });
    ...
    { dependencies: [reverseTrigger], scope: containerRef },
  );
